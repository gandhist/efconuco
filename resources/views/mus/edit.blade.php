            ...
            <div class="col-xs-4">
                <form role="form" enctype="multipart/form-data" name="formAdd" id="formAdd" method="post" action="{{ url("servicevehicle/store") }}">
                    ...
                    <div class="form-group">
                        ...
                        <input readonly name="trans_no" type="text" class="form-control" id="trans_no" value="{{ $mus_header->trans_no }}" style="width: 100%;">
                        {{-- <span class="help-block" >{{ $errors->first('trans_no') }} </span> --}}
                    </div>
                    <div class="form-group">
                        <label for="tanggal">Tanggal</label>
                        <input type="text" class="form-control" autocomplete="off" data-provide="datepicker" value="{{ $mus_header->tanggal }}" data-date-format="yyyy/mm/dd" name="tanggal" id="tanggal" placeholder="yyyy/mm/dd" required>
                        <span id="tanggal" class="help-block" >{{ $errors->first('tanggal') }} </span>
                    </div>
                    <div class="form-group">
                        <label for="nama_pembeli">Nama Pembeli</label>
                        <input type="text" class="form-control" id="nama_pembeli" name="nama_pembeli" value="{{ $mus_header->request_by }}" >
                    ...
                    <div class="form-group" id="ket_div">
                        ...
                        <textarea name="desc" text="text" class="form-control" id="desc" placeholder="Keterangan">{{ $mus_header->remarks }}</textarea>
                ...
                <div class="box-footer">
                        <a href="{{url("mus")}}" class="btn btn-default">Cancel</a>
    ...
    <div>
        <table class="table" id="data-table">
            ...
            <tfoot>
                            ...
                            <td ><b><i><input readonly type="hidden" class="form-control" id='grand_total' value="{{ $mus_header->jumlah }}"></input> <p id="grand_total_show" >{{ "Rp. " . number_format($mus_header->jumlah,2,',','.')  }}</p></i></b></td>
                            </tr> -->
            </tfoot>
