    ...
    <div class="box">
        <div class="box-body">
            ...
            <div style="margin-bottom: 20px">
                <a href="{{ url('sales/create') }}" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Buat Transaksi</a>
            </div>
...
var selectedRow;
   ...
   $('#data-table').on('click', '.delete', function (e) {
     ...
     $("#konfirmasi-body").text("Hapus Transaksi Penjualan?");
   });
